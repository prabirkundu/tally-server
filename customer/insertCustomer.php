    ...
    foreach($organizations as $org)
    {
        ...
        $xml = '<ENVELOPE>
            ...
            <LEDGER NAME="'.$value['customer_name'].'" RESERVEDNAME="">
                ...
                <LEDGERCONTACT>'.$value['customer_name'].'</LEDGERCONTACT>
                <LEDSTATENAME>'.$value['customer_site_state'].'</LEDSTATENAME>
                <LANGUAGENAME.LIST>
                <NAME.LIST TYPE="String">
                <NAME>'.$value['customer_name'].'</NAME>
                </NAME.LIST>
                </LANGUAGENAME.LIST>
                </LEDGER>
                <TALLYMESSAGE xmlns:UDF="TallyUDF">
