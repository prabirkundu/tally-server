  ...
  <REQUESTDATA>
   <TALLYMESSAGE xmlns:UDF='TallyUDF'>
    <VOUCHER REMOTEID='' VCHTYPE='Sales' ACTION='Create' OBJVIEW='Invoice Voucher View'>
     ...
     <NARRATION>Nrration if any</NARRATION>
     <COUNTRYOFRESIDENCE>India</COUNTRYOFRESIDENCE>
     <PARTYGSTIN>GSTIN NO 11</PARTYGSTIN>
     ...
     <EICHECKPOST>Agent</EICHECKPOST>
     <BASICSHIPPEDBY>Dispatched Ekart</BASICSHIPPEDBY>
     ...
     <CURRPARTYLEDGERNAME>LINC FIVE LTD</CURRPARTYLEDGERNAME>
     <CURRBASICBUYERNAME>LINC FIVE LTD</CURRBASICBUYERNAME>
     <CURRPARTYNAME>LINC FIVE LTD</CURRPARTYNAME>
    ...
    ".$xmllines."
     ...
     <INVOICEDELNOTES.LIST>
      ...
      <BASICSHIPDELIVERYNOTE>Delivery Note</BASICSHIPDELIVERYNOTE>
     </INVOICEDELNOTES.LIST>
